// @ts-nocheck
// Fond animé (vagues audio réactives à la souris) — THREE.js + post-processing + GSAP.
// Adapté du composant HeroWave pour servir d'arrière-plan à ReplyAI (page de connexion).
...
export default function WaveCanvas({ extendLeftPx = 320, className, style }: WaveCanvasProps) {
  ...
  useEffect(() => {
    ...
    function buildScene1Timeline() {
      const tl = gsap.timeline({ repeat: -1, onStart() { showScene1(); } });
  ...
  return <div ref={waveRef} aria-hidden="true" className={className} style={style} />;
}
